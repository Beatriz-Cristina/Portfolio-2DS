...
function vJogo (id){
	...
	if (src=="branco.jpg") {
		document.getElementById(id).src="imagens/" + jogador + ".jpg";

		empate++;

	if (vencedor()){
		setTimeout(function vencer(){
		alert("Fim do jogo! Parabéns !!! "+ jogador + " venceu!!!");
		},500);
	...
	return;
		...
		if (jogador =='grifinoria') {
			jogador = 'sonserina';
		}else{
			jogador = 'grifinoria';
		}
	}
	if(pc && jogador == 'sonserina'){
