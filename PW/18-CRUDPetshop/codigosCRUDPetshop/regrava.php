...
$regrava = mysqli_query($bd, "update pets set id='$id', nome_pet='$nome_pet', nascimento='$nascimento', especie='$especie', raca='$raca', cor_predominante='$cor_predominante', observacoes='$observacoes', tutor='$tutor', fone='$fone', email='$email' where id='$id'");
